 ...
 * </p>
 * <ul>
 *   <li>{@link it.unibz.inf.ontouml.xtext.xcore.impl.OntoUMLClassImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OntoUMLClassImpl extends ModelElementImpl implements OntoUMLClass {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.ONTO_UML_CLASS__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XcorePackage.ONTO_UML_CLASS__NAME:
				return getName();
		}
