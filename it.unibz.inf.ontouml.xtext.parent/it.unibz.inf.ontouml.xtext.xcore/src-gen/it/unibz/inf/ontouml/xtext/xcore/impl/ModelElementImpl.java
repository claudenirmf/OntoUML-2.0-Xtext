 ...
 * </p>
 * <ul>
 *   <li>{@link it.unibz.inf.ontouml.xtext.xcore.impl.ModelElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link it.unibz.inf.ontouml.xtext.xcore.impl.ModelElementImpl#getAlias <em>Alias</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ModelElementImpl extends MinimalEObjectImpl.Container implements ModelElement {
	...
	protected EClass eStaticClass() {
		return XcorePackage.Literals.MODEL_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.MODEL_ELEMENT__NAME, oldName, name));
	}
	...
	public void setAlias(String newAlias) {
		...
		alias = newAlias;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.MODEL_ELEMENT__ALIAS, oldAlias, alias));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XcorePackage.MODEL_ELEMENT__NAME:
				return getName();
			case XcorePackage.MODEL_ELEMENT__ALIAS:
				return getAlias();
		}
